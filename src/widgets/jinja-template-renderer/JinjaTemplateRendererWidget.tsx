  ...
  return (
    <div className="flex h-full flex-col gap-1.5 text-xs">
      ...
      <CodeEditor
        ...
        // No Jinja grammar is wired into CodeEditor, so this falls back to
        // plaintext — still gets line wrapping, just no highlighting.
        language="plaintext"
      ...
      <div className="relative min-h-0 flex-[3] overflow-auto rounded-md border border-border bg-background p-2 dark:bg-muted/40">
        {error ? (
